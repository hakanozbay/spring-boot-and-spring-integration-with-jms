...
@Component
public class GreenDataProcessor implements MessageDataProcessor {

	@Autowired
	Gateway gateway;
	
	private static final Logger log = LoggerFactory.getLogger(GreenDataProcessor.class);
	...
	public void processData (String data)
	{
		...
		catch (Exception e) 
		{
			...
			gateway.retryProcessingGreenData(data);
		}
	}
